...
class Student {
    constructor(name, fatherName, rollNumber, grade, schoolName, gender, address) {
        this.name = name;
...
while (moreStudents) {
    ...
    let studentData = new Student(userInput.stdName, userInput.stdFName, parseInt(userInput.stdRollNum), userInput.stdGrade, userInput.stdSchool, userInput.stdGender, userInput.address);
